...
class IncomeSummaryStats(APIView):
    ...
    def get_amount_for_sourse(self, income_list, source):
    ...
    def get(self, request):
        ...
        final = {}
        sources = list(set(map(self.get_sourse, income)))

        for i in income:
            for source in sources:
                final[source] = self.get_amount_for_sourse(income, source)
